...
<style>
    ...
    .stAppViewContainer {
        ...
        background: linear-gradient(135deg, #00EFF0 0%, #8AA8FF 100%);
    ...
    /* Removing the red box-shadow when the input is in focus */
    div[data-testid="stChatInput"] > label > div > div > div > input:focus {
    ...
    h1 {
        color: #00F700; /* Example: changes the color of st.title to white */
    }

    h2 {
        color: #00F700; /* Example: changes the color of st.header to orange */
    }
    /* Bot message style */
